...
plotData = function(error, data, dataType) {
  ...
  drawLabel2 = function() {
    ...
    var label2 = graph.append('g')
      .attr('id', 'label2')

    myRect = label2.append("rect")
      .attr("x", bbox.x)
      .attr("y", bbox.y)
...
d3.csv("debt_ratio.csv", function(d) {
  d.year = +d.Fiscal_Year;
  d.unapprovedDebt = +d.Non_Voter_Approved_Debt * 1000;
  d.approvedDebt = +d.Voter_Approved_Debt * 1000;
  d.totalDebt = +d.Total_Debt * 1000;
  d.receipts = +d.General_Fund_Receipts * 1000;
